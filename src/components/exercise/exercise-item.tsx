...
import { Box, Chip, createStyles, ListItem, makeStyles, Theme, Typography } from "@material-ui/core";
import { Add, Check, FitnessCenter, Info } from "@material-ui/icons";
    ...
    <ListItem button disableGutters onClick={handleClick}>
      <Box className={classes.card}>
        <Box className={classes.cardIcon} onClick={handleIconClick}>
          ...
          {
            exercise.imageUrl
              ? <img src={exercise.imageUrl} alt={exercise.title} width={70}/>
